...
async function loadOverview() {
    ...
    try {
        ...
        if (statsData.success) {
            ...
            // Social CTR (placeholder – we need total portfolio visits to calculate)
            document.getElementById('socialCtr').textContent = stats.totalClicks > 0 ? '—' : '0%';
            // Update sparklines (we'll use Chart.js mini line)
            // For simplicity, we'll skip sparklines in V1 or use small charts.
        }
