    ...
    function renderReadingPane(n) {
        ...
        readingContent.innerHTML = `
            ...
            <div class="reading-body">${renderMarkdown(n.message || "")}</div>
              ${n.cta_url ? `<div style="margin-top:22px;padding-top:18px;border-top:1px solid var(--border-color,#E2E8F0);"><a href="${n.cta_url}" style="display:inline-block;padding:11px 22px;background:var(--accent,#2563EB);color:#FFFFFF;text-decoration:none;border-radius:8px;font-size:14px;font-weight:600;">${n.cta_text || "Open"}</a></div>` : ""}
        `;
